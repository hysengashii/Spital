    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="phone" class="block w-full mt-1" type="text" name="phone" :value="old('name')" required autofocus autocomplete="phone" />
            </div>

            <div>
                <x-label for="address" value="{{ __('Address') }}" />
                <x-input id="address" class="block w-full mt-1" type="text" name="address" :value="old('name')" required autofocus autocomplete="address" />
            </div>
